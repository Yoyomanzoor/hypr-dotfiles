...
class WaifuService extends Service {
    ...
    async fetch(msg) {
        ...
        for (let i = 0; i < userArgs.length; i++) {
            ...
            else if (thisArg.includes('segs') || thisArg.includes('sex') || thisArg.includes('lewd')) this._nsfw = false;
            else {
                taglist.push(thisArg);
                if(['ecchi', 'hentai', 'ero', 'ass', 'paizuri', 'oral', 'milf'].includes(thisArg)) this._nsfw = false;
            }
        }
